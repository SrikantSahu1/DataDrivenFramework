...
public class ExcelFileUtils {
	XSSFWorkbook wb;
	//constructor for reading excel path bcz different user having different location 
	...
	//method for celldata
	// if cell contail nteger or string type data
	// string bcz strint return typr data required
	...
	/*public static void main(String[] args)throws Throwable {
		ExcelFileUtils xl = new ExcelFileUtils("F:\\testing\\latst from venket\\automation\\selenium\\Dummy.xlsx");
		//count no of rows
		...
		for(int i=1;i<=rc;i++)
		{
			...
			xl.setCellData("Login", i, 2, "Blocked", "F:\\testing\\latst from venket\\automation\\selenium\\Results.xlsx");
		}
	}
}
*/